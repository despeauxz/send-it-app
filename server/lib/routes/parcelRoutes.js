...
parcelRoutes.get('/:parcelSlug', ParcelController.fetchParcelBySlug);
parcelRoutes.put('/:parcelSlug/cancel', parcelValidation.updateParcel, validation, ParcelController.updateParcelStatus);
